...
import com.nikhilpb.util.math.LawlerBipartiteMatcher;
...
public class MatchingSamplePath {
  ...
  public MatchingSamplePath(MatchingModel model,
    ...
    this.initialPopulationSize = DistributionsCCM.nextGeometric(model.getRandom(), model.getInitPopParam());
  }
  ...
  private void computeValues(CplexFactory factory)
    ...
    IloNumExpr obj = cplex.sum(cplex.scalProd(lambdaS, onesS),
