 ...
 */
public class MatchingExperiment extends Experiment {
  ...
  public static Experiment getInstance() {
    if (instance == null) {
      instance = new MatchingExperiment();
    }
    return instance;
  }
  ...
  private boolean modelCommand(Properties props) throws Exception {
  ...
  private boolean basisCommand(Properties props) throws Exception {
    if (model == null) {
  ...
  private boolean solveCommand(Properties props) throws Exception {
    if (model == null) {
      throw new RuntimeException("model must be initialized");
    }
  ...
  private boolean evaluateCommand(Properties props) throws Exception {
    if (model == null) {
